...
cd chaincodes/asset-transfer-basic/chaincode-go
...
#export FABRIC_CFG_PATH=$PATH_HOME/config
peer version
peer lifecycle chaincode package gobasic.tar.gz --path chaincodes/asset-transfer-basic/chaincode-go/ --lang golang --label gobasic_1.0
...
export CC_CHAIN_CODE_LABEL="gobasic_1.0"
...
sleep 10
peer lifecycle chaincode approveformyorg -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --channelID proyectochannel --name gobasic --version 1.0 --package-id $CC_PACKAGE_ID --sequence 1 --tls --cafile $PATH_HOME/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem
...
sleep 10
peer lifecycle chaincode checkcommitreadiness --channelID proyectochannel --name gobasic --version 1.0 --sequence 1 --tls --cafile $PATH_HOME/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem --output json

echo "commit"
sleep 10
peer lifecycle chaincode commit -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --channelID proyectochannel --name gobasic --version 1.0 --sequence 1 --tls --cafile $PATH_HOME/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem --peerAddresses localhost:7051 --tlsRootCertFiles $PATH_HOME/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt --peerAddresses localhost:9051 --tlsRootCertFiles $PATH_HOME/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt

echo "querycommitted"
sleep 10
peer lifecycle chaincode querycommitted --channelID proyectochannel --name gobasic --cafile $PATH_HOME/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem

echo "invoke"
sleep 5
peer chaincode invoke -o localhost:7050 --ordererTLSHostnameOverride orderer.example.com --tls --cafile $PATH_HOME/organizations/ordererOrganizations/example.com/orderers/orderer.example.com/msp/tlscacerts/tlsca.example.com-cert.pem -C proyectochannel -n gobasic --peerAddresses localhost:7051 --tlsRootCertFiles $PATH_HOME/organizations/peerOrganizations/org1.example.com/peers/peer0.org1.example.com/tls/ca.crt --peerAddresses localhost:9051 --tlsRootCertFiles $PATH_HOME/organizations/peerOrganizations/org2.example.com/peers/peer0.org2.example.com/tls/ca.crt -c '{"function":"InitLedger","Args":[]}'

echo "query"
sleep 5
peer chaincode query -C proyectochannel -n gobasic -c '{"Args":["GetAllAssets"]}'